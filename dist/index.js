  ...
  _createClass(Dotenv, [{
    ...
    value: function formatData() {
      ...
      var _config5 = this.config,
          expand = _config5.expand,
          unsafeAllowAllEnvVars = _config5.unsafeAllowAllEnvVars;

      var obj = Object.keys(vars).reduce(function (obj, key) {
        var v = vars[key];
        var vKey = unsafeAllowAllEnvVars ? key : 'process.env.' + key;
        var vValue = void 0;
        if (expand) {
          if (v.substring(0, 2) === '\\$') {
